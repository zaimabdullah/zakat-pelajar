...
@section('content')
	...
	{!! Form::open(['action' => 'PostsController@store', 'method' => 'post']) !!}
    	<div class="form-group">
    		...
    		{{Form::text('pelajar', '', ['class' => 'form-control', 'placeholder' => 'Nama Pelajar'])}}
    	</div>
    	<div class="form-row">
    		<div class="form-group col-md-6">
    			{{Form::label('no_telefon', 'No H/p')}}
    			{{Form::text('no_telefon', '', ['class' => 'form-control', 'placeholder' => 'No Telefon'])}}
    		</div>
    		<div class="form-group col-md-6">
    			{{Form::label('no_matrik', 'No Matrik')}}
    			{{Form::text('no_matrik', '', ['class' => 'form-control', 'placeholder' => 'No Matrik'])}}
    		</div>
    	</div>
    	<div class="form-row">
    		<div class="form-group col-md-6">
    		...
    		<div class="form-group col-md-3">
    			...
    			{{Form::text('cgpa', '', ['class' => 'form-control', 'placeholder' => 'CGPA'])}}
    		</div>
    	</div>
    	<hr>
    	...
    	<div class="form-group">
    		...
    		{{Form::text('penjaga', '', ['class' => 'form-control', 'placeholder' => 'Nama Penuh'])}}
    	</div>
    	<div class="form-row">
    		<div class="form-group col-md-6">
    			{{Form::label('gaji', 'Pendapatan Keluarga')}}
    			{{Form::text('gaji', '', ['class' => 'form-control', 'placeholder' => 'Pendapatan Keluarga', 'aria-describedby' => 'HelpBlock'])}}
    		...
    		<div class="form-group col-md-6">
    			...
    			{{Form::text('tanggungan', '', ['class' => 'form-control', 'placeholder' => 'Jumlah Tanggungan'])}}
    		</div>
    	</div>
